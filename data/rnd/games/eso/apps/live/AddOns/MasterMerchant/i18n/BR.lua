...
ZO_CreateStringId("SK_COLOR_GUILDNAME_NAME", "Adicionar cor aos nomes das guildas")
...
ZO_CreateStringId("MM_DISPLAY_PROFIT_NAME", "Mostra lucro ao invés de margem")
ZO_CreateStringId("MM_DISPLAY_PROFIT_TIP", "Na Loja de Guilda, mostra o lucro potencial ao invés da margem percentual.")
...
ZO_CreateStringId("MM_WARN_MESSAGE_TEXT", "A partir da versão 9.3.8, o histórico da guilda parece estável. Consulte a documentação para obter informações sobre como solicitar dados ou usar a função Refresh LibHistoire.")
