...
ZO_CreateStringId("SK_DEAL_CALC_TYPE_NAME", "Typ kalkulatora transakcji")
ZO_CreateStringId("SK_DEAL_CALC_TYPE_TIP", "Wybierz z pomiędzy ceny średniej MM, średniej TTC, sugerowanej TTC, średniej Bonanza dla kalkulatora transakcji.")
...
ZO_CreateStringId("MM_TRAVEL_TO_ZONE_TEXT", "Skocz do...")

ZO_CreateStringId("MM_DISABLE_ATT_WARN_NAME", "Wyłącz ostrzeżenia ATT")
ZO_CreateStringId("MM_DISABLE_ATT_WARN_TIP", "Jeśli lubisz używać MM i ATT jednocześnie, to proszę wyłączyć ostrzeżenie o aktywnych plikach ATT przez ten przełącznik.")
...
ZO_CreateStringId("SK_COLOR_GUILDNAME_NAME", "Dodaj kolor do nazw gildii")
...
ZO_CreateStringId("SK_LISTING_REPORT_TITLE", "Oferty handlarzy")
-- endTimeFrameText on MM Graph
ZO_CreateStringId("MM_ENDTIMEFRAME_TEXT", "Teraz")
...
ZO_CreateStringId("SK_ITEM_LISTING_COLUMN", "Wystawiony przedmiot")
ZO_CreateStringId("SK_TIME_LISTING_COLUMN", "Widziany")
ZO_CreateStringId("SK_ITEM_PURCHASE_COLUMN", "Przedmiot kupiony")
ZO_CreateStringId("SK_TIME_PURCHASE_COLUMN", "Czas zakupu")
...
ZO_CreateStringId("SK_PURCHASE_TOOLTIP", "Widok zakupów")
ZO_CreateStringId("SK_BONANZA_TOOLTIP", "Widok Bonanza")
ZO_CreateStringId("SK_MANAGEMENT_TOOLTIP", "Widok zarządzania")
ZO_CreateStringId("SK_FEEDBACK_TOOLTIP", "Wyślij opinię")
ZO_CreateStringId("SK_CLOSE_TOOLTIP", "Zamknij okno")
ZO_CreateStringId("SK_NAME_FILTER_TOOLTIP", "Filtruj po nazwie")
ZO_CreateStringId("SK_TYPE_FILTER_TOOLTIP", "Filtruj po typie")
...
-- toggle view mode
ZO_CreateStringId("SK_SELLER_TOOLTIP", "Widok rankingu")
...
ZO_CreateStringId("SK_FIRST_SCAN", "Brak danych w LibGuildStore. Żądanie danych z LibHistore może zająć trochę czasu zależnie od sposobu przetrzymywania danych.")
...
ZO_CreateStringId("SK_RESET_CONFIRM_TITLE", "Potwierdź reset")
...
ZO_CreateStringId("MM_OLD_TIP_FORMAT_SINGLE", "Cena M.M. (%s, %d dzień): %.2f")
ZO_CreateStringId("MM_OLD_TIP_FORMAT_MULTI", "Cena M.M. (%s, %d dni): %.2f")
...
ZO_CreateStringId("MM_BONANZATIP_FORMAT_NONE", "Bonanza nie ma danych")
...
ZO_CreateStringId("SK_LOCATION_COLUMN", "Lokacja")
...
ZO_CreateStringId("MM_BLACKLIST_NAME", "Filtr gildii i kont")
ZO_CreateStringId("MM_BLACKLIST_TIP", "Wymień nazwy graczy i gildii które MM ma ignorować podczas kalkulacji.")
ZO_CreateStringId("MM_BLACKLIST_MENU_SELLER", "Dodaj sprzedawcę do filtru")
...
ZO_CreateStringId("MM_DISPLAY_PROFIT_NAME", "Wyświetl zysk zamiast marży")
ZO_CreateStringId("MM_DISPLAY_PROFIT_TIP", "W sklepie gildii, wyświetl potencjalny zysk zamiast procentu marży.")
...
ZO_CreateStringId("MM_SHOW_AMOUNT_TAXES_TIP", "Oblicz 3.5% całkowitej sprzedaży jako kwotę podatków dla użytkownika podczas korzystania z /mm export.")
...
ZO_CreateStringId("MM_INITIALIZED", "Master Merchant zainicjalizowany: zgromadzono %s sprzedaży, %s kupn, %s wystawień, %s anulowań.")
...
ZO_CreateStringId("MM_CHECK_STATUS", "Nazwa gildii: %s ; Wczytano liczbę zdarzeń: %s ; Liczba zdarzeń: %s ; Prędkość: %s ; Pozostało czasu: %s")
...
ZO_CreateStringId("MM_SALES_ACTIVITY_EXPORT_START", "Eksportowanie aktywności sprzedaży.")
...
ZO_CreateStringId("MM_FILTER_MENU_REMOVE_ITEM", "Usuń z filtru")
ZO_CreateStringId("MM_CLEAR_FILTER_BUTTON", "Wyczyść filtr")
...
-- notifications
ZO_CreateStringId("MM_ATT_DATA_ENABLED", "[MasterMerchant] Możesz zaimportować dane z ATT do Master Merchant z menu ustawień LibGuildStore. Możesz wyłączyć to powiadomienie w ustawieniach debugowania Master Merchant.")
...
ZO_CreateStringId("MM_WARN_MESSAGE_TEXT", "Od wersji 9.3.8 Historia Gildii wydaje się być stabilna. Zapoznaj się z dokumentacją, aby uzyskać informacje na temat żądania danych lub korzystania z funkcji Odśwież LibHistoire.")
