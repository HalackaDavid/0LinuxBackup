...
ZO_CreateStringId("SK_COLOR_GUILDNAME_NAME", "Add Color to Guild Names")
...
ZO_CreateStringId("SK_TRIM_OUTLIERS_TIP", "Ignore transactions with prices outside of a normal range from the standard deviation.")
...
ZO_CreateStringId("MM_WARN_MESSAGE_TEXT", "As of 9.3.8 Guild History seems stable. Review the documentation for information on requesting data or using the Refresh LibHistoire function.")
