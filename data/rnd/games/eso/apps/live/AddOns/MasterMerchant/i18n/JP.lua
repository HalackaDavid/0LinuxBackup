...
ZO_CreateStringId("MM_DISPLAY_PROFIT_NAME", "マージンではなく利益を表示")
ZO_CreateStringId("MM_DISPLAY_PROFIT_TIP", "ギルドストア内で、マージンパーセンテージではなく期待される利益を表示します。")
...
ZO_CreateStringId("MM_WARN_MESSAGE_TEXT", "9.3.8現在、Guild Historyは安定しているようです。データのリクエストやLibHistoireの更新機能については、ドキュメントを参照してください。")
