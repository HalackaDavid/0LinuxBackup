...
function MasterMerchant:BuildRemovedItemIdTable()
  local removedItemId = { 45844, 45845 }
  for _, itemId in pairs(removedItemId) do
    MasterMerchant.removedItemIdTable[itemId] = true
  end
end
...
function MasterMerchant:GetItemLinkFromItemId(itemId)
...
local function indexRecipes(t, index)
  ...
  if recipeId then
    -- Item is in the list!
    return MasterMerchant:GetItemLinkFromItemId(recipeId)
  end
  return nil
end
...
local function splitItem(t, index)
  ...
  return {
    { ["item"] = MasterMerchant:GetItemLinkFromItemId(potency), ["required"] = 1 },
    { ["item"] = MasterMerchant:GetItemLinkFromItemId(essence[1]), ["required"] = 1 },
    { ["item"] = MasterMerchant:GetItemLinkFromItemId(quality), ["required"] = 1 }
  }
end
