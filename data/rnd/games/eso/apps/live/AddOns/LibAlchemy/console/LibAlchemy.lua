...
-- LibAlchemy
-------------------------------------------------------------------------------
-- Originally authored by: Hyperioxes
-- First published: 2018 on ESOUI and GitHub (https://github.com/Hyperioxes/LibAlchemy)
-- No explicit license was provided. All rights reserved to the original author.
--
-- Current maintainer: Sharlikran
-- Maintained with update permissions granted via ESOUI moderator policy for
-- inactive or abandoned add-ons. See: https://www.esoui.com/forums/showthread.php?t=9865
--
-- Contributions by Sharlikran since 2023-05-22 are licensed under the BSD 3-Clause License.
-- See LICENSE file for applicable terms related to new contributions only.
-- Redistribution of the original code remains subject to the original author's rights.
-------------------------------------------------------------------------------
]]
