local strings = {
	...
	TB_ESOPLUS_CHAT					= "Ваш ESO Plus членство изменилось, войдите на других ваших персонажей, чтобы обновить свои исследовательские раз",
	TB_LINK_ACHIEVEMENT				= "Ссылка Достижение",
	TB_MAIL_KNOWN					= "Известные %s черты",
	TB_MAIL_UNKNOWN					= "Неизвестные %s черты",
